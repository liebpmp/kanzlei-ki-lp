      ...
      <div className="mx-auto max-w-[1200px] px-6 lg:px-10">
        ...
        >
          ...
          <h2 className="text-[clamp(1.75rem,4vw,2.75rem)] leading-tight tracking-tight text-text-primary">
            ...
            <br className="hidden md:block" /> ohne das Tagesgeschäft zu
            stören
          </h2>
          <p className="text-[16px] leading-relaxed text-text-secondary max-w-[600px]">
            Praxisnahe KI-Weiterbildung, speziell für Steuerkanzleien. Nur
            2 kurze Live-Calls pro Woche, der Rest läuft an Ihren eigenen
            Systemen.
          </p>
        </motion.div>
